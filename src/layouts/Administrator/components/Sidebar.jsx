...
import { Menu, PanelLeftClose, Home, BarChart2, LogOut } from 'lucide-react';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  return (
    <div className={`bg-white text-black transition-all duration-300 fixed h-full z-50
      ...
      <nav className="mt-6">
        <SidebarItem icon={<Home />} text="Dashboard" path="/" expanded={sidebarOpen || window.innerWidth < 640} />
        <SidebarItem icon={<BarChart2 />} text="Manage Pegawai" path="/manage-pegawai" expanded={sidebarOpen || window.innerWidth < 640} />
